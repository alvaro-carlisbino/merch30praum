...
async function shopifyFetch<TData>({
  ...
  if (json.errors) {
    throw new Error(`shopify gql: ${JSON.stringify(json.errors)}`);
  }
...
export async function cartCreate(
  ...
  throw new Error("cartCreate: not implemented");
}
export async function cartGet(cartId: string): Promise<DomainCart | null> {
  ...
  throw new Error("cartGet: not implemented");
}
export async function cartLinesAdd(
  ...
  throw new Error("cartLinesAdd: not implemented");
}
export async function cartLinesUpdate(
  ...
  throw new Error("cartLinesUpdate: not implemented");
}
export async function cartLinesRemove(
  ...
  throw new Error("cartLinesRemove: not implemented");
}
