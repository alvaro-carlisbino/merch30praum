# Atribuição dos assets externos

Todos os assets baixados estão sob licenças que permitem uso editorial/preview,
mas exigem crédito quando publicados. Para produção final, substituir pelos
arquivos oficiais do artista/marca quando disponíveis.

## /covers/ — Capas de álbum
Reproduções de capas de álbum oficiais distribuídas em players/widgets de
streaming (Spotify, Apple Music). Uso editorial pra referenciar os álbuns.
